...
Process__spawnSame$ = (function(location,cmd)
{
    ...
    {
      _688 = String__SplitWithoutOptions$(cmd, [" "]);
    };
    var cmd_ = _688;
...
Settings__loadOrDefault$Int32_Int32 = (function(map,def)
{
    try
    {
      ...
      var t = map(toml.parse(((fs.readFileSync((p + "/.ionide"))).toString())));
...
WebViewHandler__showWebView$ = (function(unitVar0)
{
    ...
    if (Process__isWin$()) 
    {
      ...
      _624 = Process__spawnSame$(WebViewHandler__command, args_);
    }
    else
    {
      ...
      _624 = Process__spawnSame$(WebViewHandler__linuxPrefix, _args_);
    };
    var cp = _624;
